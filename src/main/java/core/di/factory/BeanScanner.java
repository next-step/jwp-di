...
public class BeanScanner {
    ...
    public Map<HandlerKey, HandlerExecution> scan(Object... basePackage) {
        ...
        Set<Class<?>> stereoTypeBeans = getTypesAnnotatedWith(reflections, Controller.class, Service.class, Repository.class);
        for (Class<?> stereoTypeBean : stereoTypeBeans) {
            Object target = newInstance(stereoTypeBean);
            addHandlerExecution(handlers, target, stereoTypeBean.getMethods());
        }
