...
public class AnnotationHandlerMapping implements HandlerMapping {
    ...
    public AnnotationHandlerMapping(Object... basePackage) {
        ...
        this.beanScanner = new BeanScanner(Controller.class, Service.class, Repository.class);
        this.beanFactory = new BeanFactory(beanScanner.scan(this.basePackage));
    }
    ...
    public void initialize() {
        ...
        Set<Object> controllers = this.beanFactory.getBeansWithAnnotation(Controller.class);
        for (Object controller : controllers) {
            addHandlerExecution(controller, controller.getClass().getMethods());
        }
    }
