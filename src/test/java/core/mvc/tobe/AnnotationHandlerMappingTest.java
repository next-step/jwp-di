...
import core.di.factory.container.AnnotationConfigApplicationContext;
...
public class AnnotationHandlerMappingTest {
    ...
    @BeforeEach
    public void setup() {
        handlerMapping = new AnnotationHandlerMapping(new AnnotationConfigApplicationContext("next"));
